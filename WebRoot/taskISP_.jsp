                    ...
                    <div class="row">
                        <div class="col-xs-9">
                            <ul class="list-inline">
                                ...
                                <li>
                                    <input id="ispname" type="text" />
                                </li>
                                <li>
                                    <label>任务描述</label>
                                </li>
                                <li>
                                    <input id="ispdesc" type="text" />
                                </li>
                        ...
                        <div class="col-xs-3">
                            <div class="widget-box widget-color-blue2">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main" style="height: 440px; overflow-y: scroll;">
                                        <div id="DAList1">
                                        </div>
                            ...
                            <div class="widget-box widget-color-blue2">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main" style="height: 320px; overflow-y: scroll;">
                                        <div id="DSList1">
                                        </div>
                                        <div id="DSList2">
                                        </div>
    ...
    <script type="text/javascript">
        $('[data-rel=tooltip]').tooltip();
            ...
            function loadSideBar() {
                ...
                var s = '<li class> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-caret-right"></i>';
                s += 'isp_type';
            ...
            function loadDARelatives() {
                ...
                //$("#triggertype").change(function() {
                    ...
                    //if(val == "time") {
                        ...
                        //$("#attrsyb").attr("disabled", "disabled");
                        //$("#attrval").attr("disabled", "disabled");
                    //} else if(val == "state") {
                        //$("#attrid").removeAttr("disabled");
                        //$("#attrsyb").removeAttr("disabled");
                        //$("#attrval").removeAttr("disabled");
