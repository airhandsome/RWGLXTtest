...
<html>
    <head>
        ...
        $(document).ready(function() {
            ...
            $("[id^='CA-']").click(function() {
                ...
                $("#selectBtn").attr("data-focus", caid);
                $.ajax({
                    async: false,
            ...
            $("#selectBtn").click(function() {
                ...
                $.ajax({
                    url: "submitCA.action",
                    data: {caId: $(this).attr("data-focus")},
                    dataType: "json",
                    success: function(data) {
                        $("#submitBtn").attr("data-focus", data);
                    }
                });
            });
    ...
    <body>
        <div class="container-fluid" id="postnamex" data-name="<%=(String)session.getAttribute("post")%>">
            ...
            <div class="row">
                <div id="sidebar1" class="col-md-2 well" style="height: 90%; overflow-y: scroll;">
                </div>
                <div class="col-md-7 well" style="height: 90%;">
                    <div id="canvasx" style="height: 90%; overflow: scroll;">
                        <!-- <canvas id="cawell" width="1600" height="1600" onclick="getidx(show(event,'cawell'));"></canvas> -->
                    </div>
                    <div style="height: 10%">
                        <hr>
                        <div class="pull-right">
                            <button id="selectBtn" class="btn btn-primary" data-focus="">选定</button>
                            <button id="submitBtn" class="btn btn-primary" data-focus="" style="display: none;">提交</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 well" style="height: 90%;">
                    ...
                    <div style="height: 10%;">
                        <hr>
                        <div class="pull-right">
                            <button id="spcBtn" type="button" class="btn btn-primary" data-focus="">确认</button> 
                        </div>
                    </div>
                </div>
            </div>
